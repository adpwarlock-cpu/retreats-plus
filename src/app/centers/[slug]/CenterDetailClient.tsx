...
export default function CenterDetailClient({ center }: { center: RetreatCenter }) {
          ...
          <div className="lg:col-span-8 space-y-12">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <h2 className="font-serif text-2xl font-bold text-stone-900">
                  Verified Guest Reviews ({center.reviews.length})
                </h2>
            ...
            <div className="sticky top-28 bg-white rounded-3xl p-6 border border-stone-200/80 shadow-xl space-y-6">
              ...
              <div className="space-y-2.5 pt-2">
                ...
                >
                  ...
                  <span>Request Availability & Dates</span>
                </button>
